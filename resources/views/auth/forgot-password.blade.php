...
<head>
    ...
    @php
        ...
        $favType = 'image/png'; 
    @endphp
    <meta property="og:title" content="Lupa Password - {{ $appName }}">
    <meta property="og:description" content="Reset password akun aplikasi {{ $appName }}">
    ...
    <div class="row h-100">
        ...
        <div class="col-lg-6 d-none d-lg-flex login-left">
            ...
            <div class="position-relative z-1">
                ...
                <h1 class="fw-bold mb-3">Lupa Password?</h1>
                <p class="lead mb-4 op-75">Jangan khawatir. Cukup masukkan alamat email Anda dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi Anda.</p>
                ...
                <div class="d-flex align-items-center gap-3">
                     <div class="d-flex bg-white bg-opacity-10 rounded p-3 align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-white-50">Hubungi Support Tim Kami</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 login-right">
            <div class="login-form-wrapper">
                <div class="mb-5 text-center text-lg-start">
                    ...
                    <p class="text-muted">Masukkan email yang terdaftar untuk menerima link.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="text-center mt-4">
                        <p class="text-muted small"><a href="{{ route('login') }}" class="fw-bold text-decoration-none"><i class="fas fa-arrow-left me-1"></i> Kembali ke Login</a></p>
                    </div>
                </form>
            </div>
        </div>
