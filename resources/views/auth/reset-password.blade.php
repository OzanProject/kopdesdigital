...
<head>
    ...
    <title>Set Password Baru - {{ \App\Models\SaasSetting::where('key', 'app_name')->value('value') ?? config('app.name') }}</title>
    ...
    @php
        ...
        $favType = 'image/png'; 
    @endphp
    <meta property="og:title" content="Set Password Baru - {{ $appName }}">
    <meta property="og:description" content="Atur ulang kata sandi akun aplikasi {{ $appName }}">
    ...
    <div class="row h-100">
        ...
        <div class="col-lg-6 d-none d-lg-flex login-left">
            ...
            <div class="position-relative z-1">
                ...
                <h1 class="fw-bold mb-3">Buat Password Baru</h1>
                <p class="lead mb-4 op-75">Silakan buat password baru yang kuat untuk mengamankan akun koperasi Anda.</p>
                
                <div class="d-flex align-items-center gap-3">
                     <div class="d-flex bg-white bg-opacity-10 rounded p-3 align-items-center">
                        <i class="fas fa-lock fa-2x me-3"></i>
                        <div>
                            <h6 class="mb-0 fw-bold">Privasi Terjamin</h6>
                            <small class="text-white-50">Data Anda dilindungi enkripsi</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 login-right">
            <div class="login-form-wrapper">
                <div class="mb-5 text-center text-lg-start">
                    <h2 class="fw-bold text-dark">Set Password Baru</h2>
                    <p class="text-muted">Pastikan password minimal 8 karakter.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <!-- Password -->
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password Baru" required autofocus>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-muted small"><a href="{{ route('login') }}" class="fw-bold text-decoration-none"><i class="fas fa-arrow-left me-1"></i> Batal & Kembali ke Login</a></p>
                    </div>
                </form>
            </div>
        </div>
